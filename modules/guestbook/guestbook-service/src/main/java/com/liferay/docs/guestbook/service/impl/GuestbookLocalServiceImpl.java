...
import com.liferay.docs.guestbook.exception.GuestbookEmailException;
import com.liferay.docs.guestbook.exception.GuestbookMessageException;
...
public class GuestbookLocalServiceImpl extends GuestbookLocalServiceBaseImpl {
	...
	public Guestbook addGuestbook(long userId, String name, String email, String message, ServiceContext serviceContext)
	...
	@Indexable(type = IndexableType.REINDEX)
	public Guestbook updateGuestbook(long userId, long guestbookId, String name, String email, String message,
	...
	protected void validate(String name, String email, String message) throws PortalException {
		...
		if (Validator.isEmailAddress(email)) {
			throw new GuestbookEmailException();
		}

		if (Validator.isNull(message)) {
			throw new GuestbookMessageException();
		}
	}
