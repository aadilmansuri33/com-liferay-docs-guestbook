...
import com.aadil.custom.fields.model.BookModel;
import com.aadil.custom.fields.model.BookSoap;
...
/**
 * The base model implementation for the Book service. Represents a row in the &quot;custom_Book&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class BookModelImpl extends BaseModelImpl<Book> implements BookModel {
	 ...
	 */
	public static final String TABLE_NAME = "custom_Book";
	...
	public static final String TABLE_SQL_CREATE = "create table custom_Book (uuid_ VARCHAR(75) null,bookId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,bookName VARCHAR(75) null,author VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table custom_Book";
	public static final String ORDER_BY_JPQL = " ORDER BY book.bookId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY custom_Book.bookId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.aadil.custom.fields.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.aadil.custom.fields.model.Book"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.aadil.custom.fields.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.aadil.custom.fields.model.Book"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.aadil.custom.fields.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.aadil.custom.fields.model.Book"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.aadil.custom.fields.service.util.ServiceProps.get(
				"lock.expiration.time.com.aadil.custom.fields.model.Book"));
	...
	public void resetOriginalValues() {
		...
		bookModelImpl._originalBookId = bookModelImpl._bookId;

		bookModelImpl._setOriginalBookId = false;
	...
	public String toXmlString() {
		...
		sb.append("com.aadil.custom.fields.model.Book");
