...
public class BookUtil {
	...
	*/
	public static Book findByUuid_First(java.lang.String uuid,
		...
		throws com.aadil.custom.fields.exception.NoSuchBookException {
	...
	* @return the matching books
	*/
	public static List<Book> findByB_B(long bookId) {
		return getPersistence().findByB_B(bookId);
	}
	...
	* @return the range of matching books
	*/
	public static List<Book> findByB_B(long bookId, int start, int end) {
		return getPersistence().findByB_B(bookId, start, end);
	}
	...
	*/
	public static List<Book> findByB_B(long bookId, int start, int end,
		OrderByComparator<Book> orderByComparator) {
		return getPersistence().findByB_B(bookId, start, end, orderByComparator);
	}
	...
	*/
	public static List<Book> findByB_B(long bookId, int start, int end,
		OrderByComparator<Book> orderByComparator, boolean retrieveFromCache) {
		return getPersistence()
				   .findByB_B(bookId, start, end, orderByComparator,
			retrieveFromCache);
	}
	...
	* @throws NoSuchBookException if a matching book could not be found
	*/
	public static Book findByB_B_First(long bookId,
		OrderByComparator<Book> orderByComparator)
		throws com.aadil.custom.fields.exception.NoSuchBookException {
		return getPersistence().findByB_B_First(bookId, orderByComparator);
	}
	...
	* @return the first matching book, or <code>null</code> if a matching book could not be found
	*/
	public static Book fetchByB_B_First(long bookId,
		OrderByComparator<Book> orderByComparator) {
		return getPersistence().fetchByB_B_First(bookId, orderByComparator);
	}
	...
	* @throws NoSuchBookException if a matching book could not be found
	*/
	public static Book findByB_B_Last(long bookId,
		OrderByComparator<Book> orderByComparator)
		throws com.aadil.custom.fields.exception.NoSuchBookException {
		return getPersistence().findByB_B_Last(bookId, orderByComparator);
	}
	...
	* @return the last matching book, or <code>null</code> if a matching book could not be found
	*/
	public static Book fetchByB_B_Last(long bookId,
		OrderByComparator<Book> orderByComparator) {
		return getPersistence().fetchByB_B_Last(bookId, orderByComparator);
	}
	...
	* @param bookId the book ID
	*/
	public static void removeByB_B(long bookId) {
		getPersistence().removeByB_B(bookId);
	}
	...
	* @return the number of matching books
	*/
	public static int countByB_B(long bookId) {
		return getPersistence().countByB_B(bookId);
	}
